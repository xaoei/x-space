...
<div name="修改页" id="svgB">
    <div name="热门文章设置">
        ...
        <h2 style="margin-left: 1%">热门文章设置</h2>
        <hr style="height:1px;border:none;border-top:1px dashed #0066CC;">
        <div name="第一篇" style="margin-left: 5%">
            <h3 style="margin-left: 5%">第一篇</h3>
            <div style="margin-left: 5%">
                <nobr>编号:<input type="text" style="width: 5em;" id="id1" value="${index_info0.articleId}"><a
                            style="font-style: italic">(填入文章编号!)</a></nobr>
                <br>
                <nobr>标题:<input type="text" style="width: 10em;" id="title1" value="${index_info0.title}"><a
                            style="font-style: italic">(限制10个字!)</a></nobr>
                <br>
                <nobr>
                    <form id="upload1" enctype="multipart/form-data">图片:<input id="img1" type="file"
                                                                               name="multipartFile"/><a
                                style="font-style: italic">(310:180大小!)</a>
                        <button id="uploadb1" type="button" onclick="uploadImage('1');">上传</button>
                    </form>
                </nobr>
                <br>
                <a id="url1">${index_info0.headImage}</a><br>
                <nobr>感言:<input type="text" style="width: 20em;" id="feeling1" value="${index_info0.content}"><a
                            style="font-style: italic">(限制20个字!)</a></nobr>
                <br>
            </div>
        </div>
        <hr style="height:1px;border:none;border-top:1px dashed #0066CC;">
        <div name="第二篇" style="margin-left: 10%">
            <h3 style="margin-left: 10%">第二篇</h3>
            <div style="margin-left: 10%">
                <nobr>编号:<input type="text" style="width: 5em;" id="id2" value="${index_info1.articleId}"><a
                            style="font-style: italic">(填入文章编号!)</a></nobr>
                <br>
                <nobr>标题:<input type="text" style="width: 10em;" id="title2" value="${index_info1.title}"><a
                            style="font-style: italic">(限制10个字!)</a></nobr>
                <br>
                <nobr>
                    <form id="upload2" enctype="multipart/form-data">图片:<input id="img2" type="file"
                                                                               name="multipartFile"/><a
                                style="font-style: italic">(310:180大小!)</a>
                        <button id="uploadb2" type="button" onclick="uploadImage('2');">上传</button>
                    </form>
                </nobr>
                <br>
                <a id="url2">${index_info1.headImage}</a><br>
                <nobr>感言:<input type="text" style="width: 20em;" id="feeling2" value="${index_info1.content}"><a
                            style="font-style: italic">(限制20个字!)</a></nobr>
                <br>
            </div>
        </div>
        <hr style="height:1px;border:none;border-top:1px dashed #0066CC;">
        <div name="第三篇" style="margin-left: 15%">
            <h3 style="margin-left: 15%">第三篇</h3>
            <div style="margin-left: 15%">
                <nobr>编号:<input type="text" style="width: 5em;" id="id3" value="${index_info2.articleId}"><a
                            style="font-style: italic">(填入文章编号!)</a></nobr>
                <br>
                <nobr>标题:<input type="text" style="width: 10em;" id="title3" value="${index_info2.title}"><a
                            style="font-style: italic">(限制10个字!)</a></nobr>
                <br>
                <nobr>
                    <form id="upload3" enctype="multipart/form-data">图片:<input id="img3" type="file"
                                                                               name="multipartFile"/><a
                                style="font-style: italic">(310:180大小!)</a>
                        <button id="uploadb3" type="button" onclick="uploadImage('3');">上传</button>
                    </form>
                </nobr>
                <br>
                <a id="url3">${index_info2.headImage}</a><br>
                <nobr>感言:<input type="text" style="width: 20em;" id="feeling3" value="${index_info2.content}"><a
                            style="font-style: italic">(限制20个字!)</a></nobr>
                <br>
            </div>
        </div>
        <hr style="height:1px;border:none;border-top:1px dashed #0066CC;">
        <div name="第四篇" style="margin-left: 20%">
            <h3 style="margin-left: 20%">第四篇</h3>
            <div style="margin-left: 20%">
                <nobr>编号:<input type="text" style="width: 5em;" id="id4" value="${index_info3.articleId}"><a
                            style="font-style: italic">(填入文章编号!)</a></nobr>
                <br>
                <nobr>标题:<input type="text" style="width: 10em;" id="title4" value="${index_info3.title}"><a
                            style="font-style: italic">(限制10个字!)</a></nobr>
                <br>
                <nobr>
                    <form id="upload4" enctype="multipart/form-data">图片:<input id="img4" type="file"
                                                                               name="multipartFile"/><a
                                style="font-style: italic">(310:180大小!)</a>
                        <button id="uploadb4" type="button" onclick="uploadImage('4');">上传</button>
                    </form>
                </nobr>
                <br>
                <a id="url4">${index_info3.headImage}</a><br>
                <nobr>感言:<input type="text" style="width: 20em;" id="feeling4" value="${index_info3.content}"><a
                            style="font-style: italic">(限制20个字!)</a></nobr>
                <br>
            </div>
        </div>
        <button style="width: 10%;margin-left: 10%" type="button" class="btn btn-primary" id="save"
                onclick="saveHot();"><i
    ...
    <div name="精品文章设置">
        <h2 style="margin-left: 5%">精品文章设置</h2>
        <hr style="height:1px;border:none;border-top:1px dashed #0066CC;">
        <div style="margin-left: 5%" wyy>
            <nobr>编号:<input type="text" style="width: 5em;" id="idgood" value="${index_info4.articleId}"><a
                        style="font-style: italic">(填入文章编号!)</a></nobr>
            <br>
            <nobr>标题:<input type="text" style="width: 10em;" id="titlegood" value="${index_info4.title}"><a
                        style="font-style: italic">(限制10个字!)</a></nobr>
            <br>
            <nobr>
                <form id="uploadgood" enctype="multipart/form-data">图片:<input id="imggood" type="file"
                                                                              name="multipartFile"/><a
                            style="font-style: italic">(660:330大小!)</a>
                    <button id="uploadbgood" type="button" onclick="uploadImage('good');">上传</button>
                </form>
            </nobr>
            <br>
            <a id="urlgood">${index_info4.headImage}</a><br>
            <nobr>感言:<input type="text" style="width: 20em;" id="feelinggood" value="${index_info4.feeling}"><a
                        style="font-style: italic">(限制20个字!)</a></nobr>
            <br>
            <nobr>内容:<textarea rows="15" style="width: 20em" id="contextgood">${index_info4.content}</textarea><a
                        style="font-style: italic">(限制300个字!)</a></nobr>
            <br>
        </div>
    </div>
    ...
    <#--<div name="网页大图设置">-->
    <#--<hr style="height:5px;border:none;border-top:5px ridge green;" />-->
    <#--<h2 style="margin-left: 1%">网页大图设置</h2>-->
    <#--<hr style="height:1px;border:none;border-top:1px dashed #0066CC;">-->
    <#--<div name="首页" style="margin-left: 5%">-->
    <#--<h3 style="margin-left: 5%">首页</h3>-->
    <#--<div style="margin-left: 5%">-->
    <#--<nobr>图片:<input type="text" style="width: 10em;"><a style="font-style: italic">(2560:1064大小!)</a><button type="button" class="btn btn-info">上传</button></nobr><br>-->
    <#--</div>-->
    <#--</div>-->
    <#--<hr style="height:1px;border:none;border-top:1px dashed #0066CC;">-->
    <#--<div name="文章页" style="margin-left: 10%">-->
    <#--<h3 style="margin-left: 10%">文章页</h3>-->
    <#--<div style="margin-left: 10%">-->
    <#--<nobr>图片:<input type="text" style="width: 10em;"><a style="font-style: italic">(2000:200大小!)</a><button type="button" class="btn btn-info">上传</button></nobr><br>-->
    <#--</div>-->
    <#--</div>-->
    <#--<hr style="height:1px;border:none;border-top:1px dashed #0066CC;">-->
    <#--<div name="发布页" style="margin-left: 15%">-->
    <#--<h3 style="margin-left: 15%">发布页</h3>-->
    <#--<div style="margin-left: 15%">-->
    <#--<nobr>图片:<input type="text" style="width: 10em;"><a style="font-style: italic">(2000:200大小!)</a><button type="button" class="btn btn-info">上传</button></nobr><br>-->
    <#--</div>-->
    <#--</div>-->
    <#--<hr style="height:1px;border:none;border-top:1px dashed #0066CC;">-->
    <#--<div name="管理页" style="margin-left: 20%">-->
    <#--<h3 style="margin-left: 20%">管理页</h3>-->
    <#--<div style="margin-left: 20%">-->
    <#--<nobr>图片:<input type="text" style="width: 10em;"><a style="font-style: italic">(2000:200大小!)</a><button type="button" class="btn btn-info">上传</button></nobr><br>-->
    <#--</div>-->
    <#--</div>-->
...
<script src="https://blog-1252251484.cos.ap-shanghai.myqcloud.com/javascript/own/change-index.js"></script>
</#if>