        ...
        <table border="0">
            <#if (website_info)??>
                <#list website_info as wi>
                    <tr><td style="text-align: right">${wi.itemDesc}:</td>
                    <td><input id="${wi.itemName}" type="text" style="width: 20em;" value="${wi.itemValue}"></td></tr>
                </#list>
            </#if>
        </table>
    </div>
    <hr style="height:1px;border:none;border-top:1px dashed #0066CC;">
    <button style="width: 10%;margin-left: 45%" type="button" class="btn btn-primary" id="save"
            onclick="saveSiteInfo();"><i
