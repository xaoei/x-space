            ...
            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-9 col-xl-9">
                <#if (simple_article_info)??>
                    ...
                    <#list simple_article_info as sai>
                        ...
                        <td><a href="/article/author/${sai.authorId}">${sai.authorName}</a></td>
                        <td><a href="/article/type/${sai.typeId}">${sai.typeName}</a></td>
                        <td>
                    <#--<a href="/article/date/${(sai.announceTime?string("yyyyMMdd"))!}">-->
                        <a>
                        ${(sai.announceTime?string("yyyy-MM-dd"))!}</a>
                        </td>
                        <#if (role)??>
                            <#if role='admin'||role='superadmin'>
                                <td>${sai.id}</td>
                                                <td>
                                                    <button type="button" class="btn btn-danger" onclick="openDelete('article',${sai.id})">
                                    删除</button>&nbsp;&nbsp;
                            <button type="button" class="btn btn-success" onclick="openHot(${sai.id});">热门</button>
                                </td>
                            </#if>
                        </#if>
                        </tr>
                    ...
                    <#if need_page == 1>
                        ...
                        <#else >
                            ...
                            href="/article/announce_desc/${page_pre}">&laquo;</a>
                            </li>
                        </#if>
                        <#if page_total<=0>
                        ...
                        <#else>
                            <#list 1..page_total as i>
                                ...
                                <#else >
                                    <li class="page-item"><a class="page-link"
                                    href="/article/announce_desc/${i}">${i}</a></li>
                                </#if>
                            </#list>
                        </#if>
                        ...
                        <#else >
                            <li class="page-item"><a class="page-link"
                            href="/article/announce_desc/${page_next}">&raquo;</a></li>
                        </#if>
                        </ul>
                        <br>
                        </div>
