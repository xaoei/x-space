    ...
    <div name="修改页" id="svgB">
        <div name="热门文章设置">
            ...
            <div name="第一篇" style="margin-left: 5%">
                ...
                <div style="margin-left: 5%">
                    <nobr>编号:<input type="text" style="width: 5em;"><a style="font-style: italic">(填入文章编号!)</a></nobr><br>
                    <nobr>标题:<input type="text" style="width: 10em;"><a style="font-style: italic">(限制10个字!)</a></nobr><br>
                    <nobr>图片:<input type="text" style="width: 10em;"><a style="font-style: italic">(310:180大小!)</a><button type="button" class="btn btn-info">上传</button></nobr><br>
                    <nobr>感言:<input type="text" style="width: 20em;"><a style="font-style: italic">(限制20个字!)</a></nobr><br>
                </div>
            </div>
            <hr style="height:1px;border:none;border-top:1px dashed #0066CC;">
        ...
        <div name="精品文章设置">
            ...
            <div style="margin-left: 5%"wyy>
                ...
                <nobr>图片:<input type="text" style="width: 10em;"><a style="font-style: italic">(310:180大小!)</a><button type="button" class="btn btn-info">上传</button></nobr><br>
                <nobr>感言:<input type="text" style="width: 20em;"><a style="font-style: italic">(限制20个字!)</a></nobr><br>
                <nobr>内容:<textarea rows="15" style="width: 20em"></textarea><a style="font-style: italic">(限制300个字!)</a></nobr><br>
            </div>
        </div>
        <button style="width: 10%;margin-left: 10%" type="button" class="btn btn-primary" id="save"><i
                class="fa fa-floppy-o" aria-hidden="true"></i> 保存
