...
<div name="网站信息修改" id="svgB">
        ...
        <table border="0">
            <#if (friend_link)??>
                <#list friend_link as fl>
                    <nobr>名称:<input id="name${fl.id}" type="text" value="${fl.linkValue}">链接:<input id="link${fl.id}" type="text" value="${fl.linkHref}"> </nobr><br>
                </#list>
    ...
    <button style="width: 10%;margin-left: 45%" type="button" class="btn btn-primary" id="save" onclick="saveLinks();"><i
