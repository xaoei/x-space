        ...
        <div name="修改密码">
            ...
            <div name="旧的密码" style="margin-left: 5%">
                ...
                <div style="margin-left: 5%">
                    <nobr>旧的密码:<input type="password" style="width: 10em;" id="c_old_password"><a
                                style="font-style: italic">(限制10个字以上!)</a></nobr>
                    <br>
                </div>
            </div>
            <hr style="height:1px;border:none;border-top:1px dashed #0066CC;">
            <div name="新的密码" style="margin-left: 10%">
                ...
                <div style="margin-left: 10%">
                    <nobr>新的密码:<input type="password" style="width: 10em;" id="c_new_password"><a
                                style="font-style: italic">(限制10个字以上!)</a></nobr>
                    <br>
                </div>
            </div>
            ...
            <div name="再来一遍" style="margin-left: 15%">
                ...
                <div style="margin-left: 15%">
                    <nobr>再来一遍:<input type="password" style="width: 10em;" id="c_re_password"><a
                                style="font-style: italic">(限制10个字以上!)</a></nobr>
                    <br>
                </div>
            </div>
