    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <#if (short_new_article)??>
                <#list short_new_article as sna>
                    ...
                    <div class="tm-content-box"style="background:rgba(0,0,0,0.1);margin: 10px;padding: 10px">
                    ...
                    <center><a href=${sna.link} class="tm-btn text-uppercase" style="text-decoration:none">详情</a></center>
                    </div>
                </div>
                </#list>
            <#else>
        ...
        <div class="row tm-margin-t-big">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                <div class="tm-2-col-left" style="background:rgba(0,100,100,0.2);margin: 15px;padding: 15px">
                    <#if (main_article_title)??>
                        ...
                        <br/>
                        <br/>
                        <center><a href=${main_article_url} class="tm-btn text-uppercase" style="text-decoration:none">阅读全部</a></center>
                    <#else>
                        <h1>网站建设中,管理员正在添加相关文章,先收藏网址,稍后再来吧!</h1>
                    </#if>
